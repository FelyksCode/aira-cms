...
return [
    ...
    'satusehat_env' => env('SATUSEHAT_ENV', 'DEV'),

    // Dynamic client configuration based on environment
    'clientid' => env('CLIENTID_' . env('SATUSEHAT_ENV', 'DEV')),
    'clientsecret' => env('CLIENTSECRET_' . env('SATUSEHAT_ENV', 'DEV')),
    'orgid' => env('ORGID_' . env('SATUSEHAT_ENV', 'DEV')),
];
